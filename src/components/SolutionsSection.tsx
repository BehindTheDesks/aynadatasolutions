...
const SolutionsSection: React.FC = () => {
  ...
  return (
    <div
      ref={componentRef}
      className="relative w-full min-h-[100vh] flex justify-center items-center bg-data-dark-bg overflow-hidden"
    >
      <GridPattern />

      <div className="container relative w-[90%] h-full max-w-7xl">
        {/* Bars at the bottom */}
          ...
          <div className="relative w-full md:w-[80%] max-w-2xl text-center text-white">
            {textData.map((text, index) => (
              <div
                key={index}
                ref={addToRefs}
                className="text-section flex flex-col justify-center items-center absolute inset-0 w-full h-full"
              >
                <div className="pb-5">
                  <Chip
                    textSize="lg"
